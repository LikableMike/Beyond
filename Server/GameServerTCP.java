...
public class GameServerTCP extends GameConnectionServer<UUID> {
	...
	/**
	 * Informs a client of the details for a remote clients avatar. This message is
	 * in response
	 * to the server receiving a DETAILS_FOR message from a remote client. That
	 * remote clients
	 * messages localId becomes the remoteId for this message, and the remote
	 * clients messages
	...
	/**
	 * Informs a client that a remote clients avatar has changed position. x, y,
	 * and z represent
