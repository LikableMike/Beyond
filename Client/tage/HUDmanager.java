 ...
 * </ul>
 * <p>
 * This class includes a "kludge". On many systems, GLUT strings ignore the
 * glColor
...
public class HUDmanager {
	...
	protected void drawHUDs(int hcp) { // GL4 gl = (GL4) GLContext.getCurrentGL();
	...
	// Kludge to ensure HUD renders with correct color - do not call from game
	// application.
