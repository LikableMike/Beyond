 ...
 * provides accessors for them. It also maintains a link to the current game
 * application.
 * <p>
 * The first thing that a game application should do is instantiate this engine
 * class
 * using the three-argument constructor. The arguments are a link back to the
 * game application,
...
public class Engine {
	...
	/**
	 * The game application should first call this constructor, supplying a pointer
	 * back to itself.
	 */
	...
	public VariableFrameRateGame getGame() {
		return vfrg;
	}

	/** enables rendering of the graphics objects */
	public void enableGraphicsWorldRender() {
		renderGraphicsObjects = true;
	}

	/** disables rendering of the graphics objects */
	public void disableGraphicsWorldRender() {
		renderGraphicsObjects = false;
	}

	/** enables rendering of the physics objects */
	public void enablePhysicsWorldRender() {
		renderPhysicsObjects = true;
	}

	/** disables rendering of the physics objects */
	public void disablePhysicsWorldRender() {
		renderPhysicsObjects = false;
	}

	protected boolean willRenderGraphicsObjects() {
		return renderGraphicsObjects;
	}

	protected boolean willRenderPhysicsObjects() {
		return renderPhysicsObjects;
	}
}