 ...
 * Provides basic functionality for setting up OpenGL, starting and stopping a
 * game,
 * and capturing key and mouse strokes.
 * The ESC key is configured to abort the game, and the EQUALS key toggles
 * between windowed and full-screen.
 * 
 * @author Scott Gordon
 */
public abstract class VariableFrameRateGame
		implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {
	static Engine eng;

	static void setEngine(Engine e) {
		eng = e;
	}
	...
	/**
	 * Place instantiations of GameObjects, and their initial configurations in this
	...
	/**
	 * Use this function to initialize any other game stuff, node controllers, game
	 * logic, AI, etc.
	 */
	...
	/**
	 * The game application should override this function and load all game sounds
	 * in it.
	 ...
	 * It should NOT be necessary for the game application to override this
	 * function.
	 * Instead, the game application should call it when it is ready to start the
	 * game,
	...
	public void game_loop() {
		...
		System.out.println("GameLoopStartes");
	}

	/**
	 * Performs any functions necessary before shutting down the game.
	 * The game application should override this function if there are particulars
	 * to do.
	 * If overridden, the first line of the overridden function should be
	 * super.shutdown().
	 */
	 ...
	 * The game application should override this function. It is called by the
	 * engine.
	 ...
	 * of code in the function should be super.keyPressed(e) where "e" is the
	 * captured event.
	 */
