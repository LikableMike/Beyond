...
/**
 * If using TAGE, physics objects should be created using the methods in the
 * TAGE Scenegraph class.
 */
...
public abstract class JBulletPhysicsObject implements PhysicsObject {
    ...
    public static JBulletPhysicsObject getJBulletPhysicsObject(RigidBody r) {
        return lookUpObject.get(r);
    }
    ...
    /**
     * If using TAGE, physics objects should be created using the methods in the
     * TAGE Scenegraph class, rather than this constructor.
     */
     ...
     * objects in the physics world is the muplication of the two object's
     * bounciness
     * coefficient.
     *
     * @param bounciness
