...
public class Utils {
	...
	// Crystal material - ambient, diffuse, specular, and shininess
	public static float[] crystalAmbient() {
		return (new float[] { 0.1745f, 0.01175f, 0.01175f, 0.55f });
	}

	public static float[] crystalDiffuse() {
		return (new float[] { 0.61424f, 0.04136f, 0.04136f, 0.55f });
	}

	public static float[] crystalSpecular() {
		return (new float[] { 0.727811f, 0.626959f, 0.626959f, 0.55f });
	}

	public static float crystalShininess() {
		return 76.8f;
	}

	// Crystal material - ambient, diffuse, specular, and shininess
	public static float[] blueOreAmbient() {
		return (new float[] { .01175f, 0.01175f, 0.1745f, 0.55f });
	}

	public static float[] blueOreDiffuse() {
		return (new float[] { 0.04136f, 0.04136f, 0.61424f, 0.55f });
	}

	public static float[] blueOreSpecular() {
		return (new float[] { 0.626959f, 0.626959f, 0.727811f, 0.55f });
	}

	public static float blueOreShininess() {
		return 76.8f;
	}

	// Crystal material - ambient, diffuse, specular, and shininess
	public static float[] BeamAmbient() {
		return (new float[] { 0.0215f, 0.1745f, 0.0215f, 1f });
	}

	public static float[] BeamDiffuse() {
		return (new float[] { 0, 0.61424f, 0, 1f });
	}

	public static float[] BeamSpecular() {
		return (new float[] { 0, 0.727811f, 0, 1f });
	}

	public static float BeamShininess() {
		return 76.8f;
	}

	public static float[] ShipAmbient() {
	 ...
	 */
	public static float[] ShipDiffuse() {
		return (new float[] { 0.8f, 0.8f, 0.8f, 1 });
	}

	/**
	 * Default material - returns specular component
	 */
	public static float[] ShipSpecular() {
		return (new float[] { 0.8f, 0.8f, 0.8f, 1 });
	}
	 ...
	 */
	public static float ShipShininess() {
		return 30.0f;
	}
	...
	public static float[] defAmbient() {
		return (new float[] { 0.1f, 0.1f, 0.1f, 1 });
	}
	...
	public static float[] defDiffuse() {
		return (new float[] { 0.2f, 0.2f, 0.2f, 1 });
	}
