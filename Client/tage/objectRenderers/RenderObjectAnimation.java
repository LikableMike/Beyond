...
{	private GLCanvas myCanvas;
	...
	private int mLoc, vLoc, pLoc, nLoc, eLoc, tLoc, lLoc, fLoc, sLoc, cLoc, oLoc;
	private int globalAmbLoc,mambLoc,mdiffLoc,mspecLoc,mshiLoc;
	private int skinMatLoc, skinMatITLoc;
	private int hasSolidColor, hasTex, thisTexture, defaultTexture, tiling, tilingOption, hasLighting;
